  ...
  return (
    <div className="addEmployeeContainer">
      ...
      <p className="error">{error}</p>
        ...
        <p className="skillText">If you don't find your skills, add your skills here!</p>
        ...
        <button className="submitButton" onClick={onHandleSkill}>Add Skill</button>
          </div>
        </div>
      </div>

      <div>
        <img className="marginRight" src="/RMtoolSVGs/AddSkillSVG.svg" alt="AddSkill" />
      </div>
    </div>
  );
}
